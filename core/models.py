...
class WakalaRole(models.Model):
    ...
    wakala = models.ForeignKey(
        "wakala.Wakala", on_delete=models.CASCADE, related_name="roles"
    )
    user = models.ForeignKey(
        settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name="wakala_roles"
    )
...
class MchezoRole(models.Model):
    ...
    group = models.ForeignKey(
        "mchezo.Group", on_delete=models.CASCADE, related_name="roles"
    )
    user = models.ForeignKey(
        settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name="mchezo_roles"
    )
